...
def combined_report(original_report_lines, enhanced_report_lines, comparison_results,
    ...
    with open('enhanced_classifier_report.txt', 'w') as f:
    ...
    print(f"Combined report saved to enhanced_classifier_report.txt")
...
if __name__ == "__main__":
    ...
    # Write the best prediction to predictions.csv for submission
    if enhanced_best > original_best:
        print("\nUsing enhanced data model predictions for submission (better accuracy)")
        enhanced_pred_df.to_csv('submission/predictions.csv', index=False)
    else:
        print("\nUsing original data model predictions for submission (better accuracy)")
